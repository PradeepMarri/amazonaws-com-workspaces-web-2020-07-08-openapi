# Amazon WorkSpaces Web MCP Server

This MCP (Model Content Protocol) server provides access to Amazon WorkSpaces Web API functionality through HTTP, HTTPS, and STDIO transport modes.
