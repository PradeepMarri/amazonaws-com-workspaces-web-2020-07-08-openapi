...
func DeleteidentityproviderHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var result models.DeleteIdentityProviderResponse
...
func CreateDeleteidentityproviderTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("delete_identityProviders_identityProviderArn",
		mcp.WithDescription("Deletes the identity provider."),
		mcp.WithString("identityProviderArn", mcp.Required(), mcp.Description("The ARN of the identity provider.")),
	)

	return models.Tool{
		Definition: tool,
		Handler:    DeleteidentityproviderHandler(cfg),
	}
}
