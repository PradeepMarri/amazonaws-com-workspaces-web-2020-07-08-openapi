...
func CreateTagresourceTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_tags_resourceArn",
		mcp.WithDescription("Adds or overwrites one or more tags for the specified resource."),
		mcp.WithString("resourceArn", mcp.Required(), mcp.Description("The ARN of the resource.")),
		mcp.WithArray("tags", mcp.Required(), mcp.Description("Input parameter: The tags of the resource.")),
	)
