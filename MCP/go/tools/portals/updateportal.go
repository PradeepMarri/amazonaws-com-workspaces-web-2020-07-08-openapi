...
func UpdateportalHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var result models.UpdatePortalResponse
...
func CreateUpdateportalTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("put_portals_portalArn",
		mcp.WithDescription("Updates a web portal."),
	...
	return models.Tool{
		Definition: tool,
		Handler:    UpdateportalHandler(cfg),
	}
}
