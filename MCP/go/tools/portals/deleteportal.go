...
func DeleteportalHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/portals/%s", cfg.BaseURL, portalArn)
		...
		var result models.DeletePortalResponse
...
func CreateDeleteportalTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("delete_portals_portalArn",
		mcp.WithDescription("Deletes a web portal."),
		mcp.WithString("portalArn", mcp.Required(), mcp.Description("The ARN of the web portal.")),
	)

	return models.Tool{
		Definition: tool,
		Handler:    DeleteportalHandler(cfg),
	}
}
