...
func GetportalHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var result models.GetPortalResponse
...
func CreateGetportalTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_portals_portalArn",
		mcp.WithDescription("Gets the web portal."),
		mcp.WithString("portalArn", mcp.Required(), mcp.Description("The ARN of the web portal.")),
	)

	return models.Tool{
		Definition: tool,
		Handler:    GetportalHandler(cfg),
	}
}
