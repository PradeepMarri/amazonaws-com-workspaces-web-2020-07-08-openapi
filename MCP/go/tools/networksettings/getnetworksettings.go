...
func GetnetworksettingsHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var result models.GetNetworkSettingsResponse
...
func CreateGetnetworksettingsTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_networkSettings_networkSettingsArn",
		mcp.WithDescription("Gets the network settings."),
		mcp.WithString("networkSettingsArn", mcp.Required(), mcp.Description("The ARN of the network settings.")),
	)

	return models.Tool{
		Definition: tool,
		Handler:    GetnetworksettingsHandler(cfg),
	}
}
