...
func ListusersettingsHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/userSettings%s", cfg.BaseURL, queryString)
		...
		var result models.ListUserSettingsResponse
...
func CreateListusersettingsTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_userSettings",
		mcp.WithDescription("Retrieves a list of user settings."),
	...
	return models.Tool{
		Definition: tool,
		Handler:    ListusersettingsHandler(cfg),
	}
}
