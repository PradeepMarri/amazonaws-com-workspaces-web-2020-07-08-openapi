...
func ListtruststoresHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/trustStores%s", cfg.BaseURL, queryString)
		...
		var result models.ListTrustStoresResponse
...
func CreateListtruststoresTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_trustStores",
		mcp.WithDescription("Retrieves a list of trust stores."),
	...
	return models.Tool{
		Definition: tool,
		Handler:    ListtruststoresHandler(cfg),
	}
}
