...
func ListtruststorecertificatesHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/trustStores/%s/certificates%s", cfg.BaseURL, trustStoreArn, queryString)
		...
		var result models.ListTrustStoreCertificatesResponse
...
func CreateListtruststorecertificatesTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_trustStores_trustStoreArn_certificates",
		mcp.WithDescription("Retrieves a list of trust store certificates."),
	...
	return models.Tool{
		Definition: tool,
		Handler:    ListtruststorecertificatesHandler(cfg),
	}
}
